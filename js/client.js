...
var voteCallBack = function(t, opts) {
  return t.popup({
    title: 'Set Priority',
    items: [{
      text: 'Nice to have',
      callback: function(t, opts){
        t.set('card', 'shared', 'nice_to_have', t.get('card', 'shared', 'nice_to_have')+1)
      }
    },
    {
      text: 'Important',
      callback: function(t, opts){
        t.set('card', 'shared', 'important', t.get('card', 'shared', 'important')+1)
      }
    },
    {
      text: 'Critical',
      callback: function(t, opts){
        t.set('card', 'shared', 'critical', t.get('card', 'shared', 'critical')+1)
      }
    }]
  })
}
