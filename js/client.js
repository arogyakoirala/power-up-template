...
TrelloPowerUp.initialize({
  'card-detail-badges': function(t, opts) {
    return t.get('card', 'private', 'selection').then(function(selection){
      return [{
            ...
            items: [
              {
                text: 'Nice to have',
                callback: function(t, opts){
                  return t.set('card', 'private', {'selection': 'nth'})
                  .then(function(){
                    return t.getAll()
                  })
                  .then(function(allValues){
                    ...
                    return t.set('card', 'shared', {
                      nth: (allValues.card && allValues.card.shared && allValues.card.shared.nth) && (allValues.card.private.selection === "nth") ?  allValues.card.shared.nth: (allValues.card && allValues.card.shared && allValues.card.shared.nth) && !(allValues.card.private.selection === "nth") ? allValues.card.shared.nth + allValues.card.private.nth : 1,
              ...
              },
              {
                text: 'Important',
                callback: function(t, opts){
                  return t.set('card', 'private', {'selection': 'imp'})
                  .then(function(){
                    return t.getAll()
                  })
                  .then(function(allValues){
                    ...
                    return t.set('card', 'shared', {
                      ...
                      imp: ((allValues.card && allValues.card.shared && allValues.card.shared.imp) && (allValues.card.private.selection === "imp")) ?  allValues.card.shared.imp: ((allValues.card && allValues.card.shared && allValues.card.shared.imp) && !(allValues.card.private.selection === "imp")) ? allValues.card.shared.imp + allValues.card.private.imp : 1,
                      cri: (allValues.card && allValues.card.shared && allValues.card.shared.cri) ? allValues.card.shared.cri : 0,
                    })
                  }).then(function(){
                    t.closePopup();
              ...
              },
              {
                text: 'Critical',
                callback: function(t, opts){
                  return t.set('card', 'private', {'selection': 'cri'})
                  .then(function(){
                    return t.getAll()
                  })
                  .then(function(allValues){
                    ...
                    return t.set('card', 'shared', {
                      nth: (allValues.card && allValues.card.shared && allValues.card.shared.nth) ? allValues.card.shared.nth: 0,
                      imp: (allValues.card && allValues.card.shared && allValues.card.shared.imp) ? allValues.card.shared.imp: 0,
                      cri: (allValues.card && allValues.card.shared && allValues.card.shared.cri) && (allValues.card.private.selection === "cri") ?  allValues.card.shared.cri: (allValues.card && allValues.card.shared && allValues.card.shared.cri) && !(allValues.card.private.selection === "cri") ? allValues.card.shared.cri + allValues.card.private.cri : 1,
                    })
                  }).then(function(){
                    t.closePopup();
                  })
              ...
              },
              {
                text: 'unspecified',
                callback: function(t, opts){
                  return t.set('card', 'private', {'selection': 'unspecified'})
                  .then(function(){
                    return t.getAll()
                  })
                  .then(function(allValues){
