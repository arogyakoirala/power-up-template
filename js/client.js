...
TrelloPowerUp.initialize({
  ...
  "card-badges": function (t, opts) {
    return t.getAll().then(function (allValues) {
      ...
      var imptext = (allValues.card && allValues.card.shared && allValues.card.shared.imp) ? allValues.card.shared.nth && " • "||"" + "Important: " + String(allValues.card.shared.imp): "";
      var criticaltext = (allValues.card && allValues.card.shared && allValues.card.shared.cri) ? (allValues.card.shared.imp || allValues.card.shared.nth )  && " • "||"" + "Critical: " + String(allValues.card.shared.cri): "";
