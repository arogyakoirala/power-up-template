    ...
    return t.get('card', 'private', 'selected').then(function(selected){
      ...
      "card-badges": function(t, opts){
        return t.getAll().then(function(allValues){
          var selection = allValues.card.private.selected || 'unspecified';
          var counts = allValues.card.shared.nth + allValues.card.shared.imp + allValues.card.shared.cri || 0

          return [
            {
              text: textMapper[selection],
              color:'green',
            },
